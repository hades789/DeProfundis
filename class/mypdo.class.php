...
class mypdo extends PDO{
    ...
    public function liste_article($title)	
    {
		...
		$requete='select a.h3,a.corps, a.date_redaction, s.nom, s.prenom, g.intitule from article a,page p,salarie s,grade g where a.page=p.id and s.grade=g.id and s.id=a.salarie and p.title="'.$title.'";';
